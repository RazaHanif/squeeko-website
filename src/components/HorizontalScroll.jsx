        ...
        <div className="overflow-hidden py-12">
            ...
            <div className="relative">
                ...
                <div className="marquee marquee--8">
                    <div className="marquee__item border border-primary text-primary font-mono font-bold  rounded-2xl flex flex-col justify-center items-center text-center px-6 py-4">
                        block
                    </div>
                    <div className="marquee__item border border-primary text-primary font-mono font-bold  rounded-2xl flex flex-col justify-center items-center text-center px-6 py-4">
                        block
