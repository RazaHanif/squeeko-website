    ...
    return (
        <div className="w-full">
            <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-30 bg-gradient-to-r from-background to-primary" />
                <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-30 bg-gradient-to-l from-background to-primary" />
                ...
                >
                    {scrollList.map((item, idx) => (
                        <div 
                            ...
                            className="marquee_item cursor-pointer text-background font-serif font-bold text-xl flex justify-center items-center text-center"
                        >
                            {item}
                        </div>
                    ))}
