        ...
        <div className="overflow-hidden py-12">
            ...
            <div className="relative">
                ...
                <div className="marquee marquee--8">
                    <div className="marquee__item bg-red-500 border-blue-500 border rounded-2xl text-blue-500 flex flex-col justify-center items-center text-center px-6 py-4">
                        block
                    </div>
                    <div className="marquee__item bg-red-500 border-blue-500 border rounded-2xl text-blue-500 flex flex-col justify-center items-center text-center px-6 py-4">
                        block
