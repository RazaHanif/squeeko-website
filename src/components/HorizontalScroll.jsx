                ...
                >
                    {scrollList.map((item, idx) => (
                        <div 
                            ...
                            className="marquee_item w-max min-w-40 cursor-pointer text-primary font-serif font-bold text-xl flex justify-center items-center text-center text-nowrap"
                        >
                            {item.toUpperCase()}
                        </div>
                    ))}
