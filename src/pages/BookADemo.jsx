    ...
    return (
        <div className="flex flex-col flex-1 w-9/10 lg:w-3/4 lg:py-16 py-8">
            ...
            <div className="flex flex-col justify-center items-center w-full text-muted-foreground">
                <p>
                    Again just sales funnel so we can call them and book a demo or sign them up for the waitlist. Maybe this should be sign up for waitlist right now, now that i think about it.
                </p>
            </div>
