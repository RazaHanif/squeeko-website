...
function Home() {
    ...
    return (
        <div className="flex flex-col flex-1 w-9/10 lg:w-3/4 lg:py-16 py-8 border-t-2 border-red-500">
            <section 
                className="snap-section min-h-[calc(100vh-80px)] w-full flex flex-col justify-start items-center">
                <div className="w-full flex flex-col justify-center items-center gap-4 border">
                    <p className="text-xs font-bold">
                        CHILD CARE MANAGEMENT SOFTWARE  
                    </p>
                    <h1 className="text-5xl font-serif text-center font-bold">
