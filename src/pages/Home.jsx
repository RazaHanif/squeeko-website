    ...
    return (
        <div className="flex-1 flex flex-col justify-center items-center w-full lg:py-16 py-8">
            <section className="snap-section min-h-[calc(100vh-80px)] flex flex-col justify-start items-center gap-8 w-full bg-[url('home-hero.svg')] bg-cover bg-center">
                <div className="w-3/4 lg: flex flex-col justify-center items-center gap-4">
                    ...
                    <p className="w-3/4 lg: text-center font-light">
                ...
                <div className="w-3/4 lg: flex flex-row justify-center items-center gap-6">
                    <Button 
                        variant="default"
                ...
                <div className="w-3/4 lg: flex flex-1 flex-row border rounded-lg bg-primary text-primary-foreground overflow-hidden">
