    ...
    return (
        <div className="flex flex-col flex-1 w-9/10 lg:w-3/4 lg:py-16 py-8">
            <section className="snap-section min-h-[calc(100vh-80px)] w-full flex flex-col justify-start items-center gap-8">
                ...
                <div className="w-full flex flex-1 flex-row justify-center items-center border">
                    <div className="w-full flex-1 shrink-0 flex flex-col justify-center items-center border border-primary bg-primary text-primary-foreground">
