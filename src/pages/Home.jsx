...
function Home() {
    ...
    return (
        <div className="flex-1 flex flex-col justify-center items-center w-full lg:py-16 py-8">
            ...
            <section className="snap-section min-h-[calc(100vh-80px)] flex flex-col justify-start items-center w-full bg-primary/50 text-primary-foreground">
                ...
                <div className="w-9/10 lg:w-3/4 border border-red-500">
